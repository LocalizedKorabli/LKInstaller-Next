...
### 下载线路
- [蓝奏云分享](https://www.ilanzou.com/s/sGJNCdgD)
...
在**关于**页中，您可以：
- 查看应用的版本，并为应用**检查更新**；
- 点击图标为GitHub、QQ、Discord的按钮来查看此应用的源代码仓库或加入本团队在对应社交平台上的群组；
...
请根据您所使用的语言和客户端类型，在[团队主页传送门](https://github.com/LocalizedKorabli#%E9%A1%B9%E7%9B%AE%E4%BC%A0%E9%80%81%E9%97%A8portal)中找到相关的仓库并在其Issues中提交反馈。
